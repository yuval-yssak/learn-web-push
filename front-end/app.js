...
const $enableNotifications = document.querySelector(".btn__enable-notifications");
const $hostUrlInput = document.querySelector(".input__host_url");

let hostUrl = "";

$hostUrlInput.addEventListener("change", (e) => (hostUrl = e.target.value));
...
async function configurePushSubscription(swReg) {
    const vapidPublicKey = "BAX_0TF8ANYwXuAIxcgcmjokFlq2XlT3HHWUyEQTy7Aze2_U_tRnD2NwDLw0hZrWm77C1765FOro81lLn6O8PuU";
    ...
    if (subscription === null) {
        ...
        const response = await fetch(`${hostUrl}/subscribe`, {
            method: "POST",
            headers: {
